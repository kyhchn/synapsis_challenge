...
import 'package:synapsis_challenge/pages/survei_view.dart';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              separator(),
              inputField(emailController, 'Email', TextInputType.emailAddress),
              SizedBox(
                height: 2.h,
              ),
              inputField(
                      ...
                      child: SynapsisButton(
                        ...
                        onclick: () async {
                          ...
                          final response = await dio.post(
                              'https://panel-demo.obsight.com/api/login',
                              data: {
